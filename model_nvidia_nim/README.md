...
```shell
oc create secret docker-registry nim-pull-secret --docker-username='$oauthtoken' --docker-server='nvcr.io' --docker-password='nvapi-XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX'
```
